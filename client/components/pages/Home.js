...
const Home = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      categoryName: "Shoes",
      imageUrl:
        "https://n.nordstrommedia.com/id/sr3/133be703-7505-407d-bd7f-31848829ac35.jpeg?crop=pad&pad_color=FFF&format=jpeg&trim=color&trimcolor=FFF&w=780&h=838",
    },
    {
      category: "top",
      categoryName: "Tops",
    ...
    <div>
      <Box
        sx={{
          ...
          alignItems: "center",
          backgroundImage: "url(https://cdn.builder.io/api/v1/image/assets%2FbqNZC3dTGjwbxXySE419%2F90b637f86e6a4f41b800905192f3dc02?width=2000)",
          minHeight: "500px",
      ...
      >
        <Box sx={{ marginBottom: "60px" }}>
          ...
          <Typography variant="h3" sx={{ fontStyle: "italic", fontFamily: "Cardo" }}>
            Get Inspired
          </Typography>
        </Box>
      </Box>
      <Box>
        ...
        >
          {firstName ? `${firstName}, shop the latest styles now!` : "Shop the latest styles now!"}
        </Typography>
      </Box>
      <Box>
        <Grid
        ...
        >
          {products.map((product) => {
            return (
              <Grid item xs={12} sm={6} md={4} lg={3} key={product.category}>
                <TitleCard key={product.categoryName} product={product} />
              </Grid>
            );
          })}
        </Grid>
